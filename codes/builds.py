...
# def build_agency(base_data: pd.DataFrame) -> pd.DataFrame:
#     """
#     버스 노선정보를 바탕으로 agency 파일을 생성한다.
#     """
#     routes = base_data["route_id"]

#     def build_agency_helper(route_id: str) -> list:
#         res = requests.get(
#             url=
#         )

# def build_agency(bus_file: Path) -> pd.DataFrame:
#     """
